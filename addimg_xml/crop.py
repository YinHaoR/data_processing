...
def main():
    imgs_dir = 'E:/dataset/SSDD SAR dataset/old/JPEGImages/'
    xmls_dir = 'E:/dataset/SSDD SAR dataset/old/Annotations/'

    imgs_save_dir = 'E:/datasets/SSDD SAR dataset/new/imgs/'
    if not os.path.exists(imgs_save_dir):
        os.makedirs(imgs_save_dir)
    xmls_save_dir = 'E:/datasets/SSDD SAR dataset/new/xml/'
    if not os.path.exists(xmls_save_dir):
        os.makedirs(xmls_save_dir)
    img_suffix = ['.jpg', '.png', '.bmp']
    name_suffix = 'crop'  # 命名标识
    crop_type = 'CENTER_CROP'  # ['RANDOM_CROP','CENTER_CROP','FIVE_CROP']
    crop_n = 1 # 每张原图 crop 5张图
    dsize = (544,544)  # 指定裁剪尺度
    fw =1
    fh =1 # 指定裁剪尺度比例
