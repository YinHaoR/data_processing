...
path = r'E:\\shipdata\\xml\\'  # 原文件夹路径
newpath = r'E:\\shipdata\\xml-1024\\'  # 新文件夹路径
c_w, c_h = 1024, 1024  # 目标图片的尺寸
...
def edit_xml(xml_file, ratio, i):
    ...
    newfile = os.path.join(newpath, xml_file)
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        if file.endswith('.jpg'):
            ...
            # 设置新的文件名：
            # newName = os.path.join(newpath, '%03d' % (0+i) + '.jpg')
            newName = os.path.join(newpath,file)
            i += 1
            print(newName)
