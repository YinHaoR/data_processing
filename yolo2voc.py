...
class YOLO2VOCConvert:
    def __init__(self, txts_path, xmls_path, imgs_path):
        ...
        self.classes = ['airplane', 'ship', 'storage tank', 'baseball diamond', 'tennis court', 'basketball court', 'ground track field',
 'harbor', 'bridge', 'vehicle']  # 注意：这里根据自己的类别名称及种类自行更改
...
if __name__ == '__main__':
    ...
    # yolo格式txt标签文件相对路径
    txts_path1 = 'F:\\remake-nwpu-yolo\\yolov5\\val\\labels\\'
    # 转化为voc格式xml标签文件存储的相对路径
    xmls_path1 = 'F:\\remake-nwpu-yolo\\yolov5\\val\\xml\\'
    # 存放图片的相对路径
    imgs_path1 = 'F:\\remake-nwpu-yolo\\yolov5\\val\\images\\'
