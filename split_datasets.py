...
if __name__ == '__main__':
    # train 从train中移动
    train_img_Dir = 'E:/dataset/shipdata/train/images/'
    train_mask_Dir = 'E:/dataset/shipdata/train/labels/'
    # test路径：图片和标注目录
    test_img_Dir = 'E:/dataset/shipdata/test/images/'
    test_mask_Dir = 'E:/dataset/shipdata/test/labels/'
    # val路径：图片和标注文目录
    val_img_Dir = 'E:/dataset/shipdata/val/images/'
    val_mask_Dir = 'E:/dataset/shipdata/val/labels/'
    # 运行划分数据集函数
